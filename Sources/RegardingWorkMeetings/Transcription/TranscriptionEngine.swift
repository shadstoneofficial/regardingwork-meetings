...
/// A speech-to-text engine RegardingWork Meetings can run locally. Engines are prepared lazily
/// (model download + load) when the transcription queue has work and released
/// when it drains, so the app never idles holding gigabytes of model weights.
